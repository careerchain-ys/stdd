...
- 確信が持てないカラム・型は、説明欄に **要確認マーカー** を仮説とセットで置く（`⚠️要確認(仮説: … / 確認: …)`）。ユーザーが是非を確定したら除去する。構文の SSoT は [documenting-requirements SKILL「要確認マーカー」](../../documenting-requirements/SKILL.md) を参照。
