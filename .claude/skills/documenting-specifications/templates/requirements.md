...
- データモデル（テーブル定義・RLS）・集計実装・API 設計 → **TECH_DESIGN.md**
- 画面項目 × バリデーション × DB マッピング → **SCREEN_ITEMS_DEFINITION.md**
- E2E テストの実装詳細（テストデータ・セレクタ・step 実装）→ **テストコード**
